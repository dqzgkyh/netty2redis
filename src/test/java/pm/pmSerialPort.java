...
public class pmSerialPort implements Runnable, SerialPortEventListener {
    ...
    // 单例创建
    private static pmSerialPort uniqueInstance = new pmSerialPort();
        ...
        if (portId.getPortType() == CommPortIdentifier.PORT_SERIAL) {
            ...
            if ("COM5".equals(portId.getName())) {
                ...
                try {
                    ...
                    serialPort = (gnu.io.SerialPort) portId.open(Object.class.getSimpleName(), 1500);
                    //实例化输入流
                    ...
                    // 波停特率，数据校位，止位和验方式
                    // 波特率9600,无校验
                    serialPort.setSerialPortParams(9600, gnu.io.SerialPort.DATABITS_8, //
...
//
                    ...
                    System.out.println("pm2.5 and pm10: "+pm2AndPm10);
                    break;
                }
...
//        String information = "020302000002C580\r";
        String information = "040302000002C580";
